...
function printLetter(caseItem, evidence, field = "complaint_letter", label = "1st Complaint Letter") {
  ...
  <style>
    ...
    .letter-content { position: relative; padding: 25mm 25mm 20mm 25mm; margin: 0; font-family: 'Times New Roman', Times, serif; font-size: 11pt; color: #000; line-height: 1.6; width: 100%; }
    .letter-content p { margin: 10pt 0; min-height: 18pt; font-size: 11pt; }
    ...
    .continuation-content p { margin: 10pt 0; min-height: 18pt; font-size: 11pt; }
