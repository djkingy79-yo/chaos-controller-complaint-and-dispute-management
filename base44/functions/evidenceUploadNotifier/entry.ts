...
Deno.serve(async (req) => {
  try {
    ...
    const html = htmlEmail(`
      <p style="color:#666666;font-size:12px;margin:0 0 20px 0;text-transform:uppercase;letter-spacing:1px;">NEW EVIDENCE UPLOADED</p>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9f9f9;border-radius:8px;padding:16px;margin:20px 0;">
        <tr><td style="padding:6px 0;color:#666666;font-size:12px;width:120px;">Case</td><td style="color:#000000;font-weight:bold;">${caseItem.title}</td></tr>
        ...
        <tr><td style="padding:6px 0;color:#666666;font-size:12px;">File</td><td style="color:#b45309;font-weight:bold;">${evidence.file_name}</td></tr>
        <tr><td style="padding:6px 0;color:#666666;font-size:12px;">Type</td><td style="color:#333333;">${fileTypeLabel}</td></tr>
        ${evidence.description ? `<tr><td style="padding:6px 0;color:#666666;font-size:12px;">Description</td><td style="color:#333333;">${evidence.description}</td></tr>` : ''}
        ${evidence.event_date ? `<tr><td style="padding:6px 0;color:#666666;font-size:12px;">Dated</td><td style="color:#333333;">${new Date(evidence.event_date).toLocaleDateString('en-AU', { day: 'numeric', month: 'long', year: 'numeric' })}</td></tr>` : ''}
      </table>
      <p style="color:#666666;">Your evidence vault is growing stronger. Log in to review and continue building your case.</p>
